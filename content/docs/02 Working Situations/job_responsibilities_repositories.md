...
- Six years of rewarding supervisory experience with making positive marks in supervisees' career.\
- Leadership in laboratories going through transitions.

<br><font color =#3fb5bd>Chemist</font>\
- 15 years of experience in improving efficiency and effectiveness in overall lab operation, including accredited analysis, data processing, and quality management system.

<br><font color =#3fb5bd>Scientist</font>\
- Experience in performing R&D for improvement in production laboratory.

<br><font color =#3fb5bd>Clinic diagnostic lab</font>\
...
<br><font color =#3fb5bd>Nuclear Science Based Lab</font>\
- Seven years of experience in the analysis of both radiological and non-radiological parameters on both aqueous and biota samples at Whiteshell Laboratories.

# LifeLabs

<font color =#3fb5bd>Scientist</font>\
- Investigation of complete hydrolysis of steroid conjugates and quantitative extraction of free steroids from urine followed by GC-MS/MS or LC-MS/MS.\
- Performed pre-study validation for a bile acid metabolite in serum.

<br><font color =#3fb5bd>data processing</font>\
- Improved data processing, data interpretation, and reporting with macro in Excel, pivot table and R.\

<br><font color =#3fb5bd>QC</font>\
- Improved QC data monitoring with R Shiny application.\

<br><font color =#3fb5bd>Instrument maintenance and troubleshooting</font>\
- Created a proactive instrument maintenance program with R Shiny application.\
- Developed an electronic troubleshooting logbook prototype.\
...
- Responsible for the day-to-day laboratory operation. (4 staff)\
- Initiated business analysis and setup goals for team and individuals using SMART approach resulting performance improvement.\
...
- Developed and validated a headspace-GC/MS method for volatile organic compounds in the aqueous matrix.\
- Responsible for re-validation of ICP-OES, IC, CVAFS, and FAAS methods of analytes in environmental samples.

<font color =#3fb5bd>Data processing</font>\
- Developed some Excel macros to improve data processing and reporting: data processing time was cut from three days to a few hours, and data accuracy increased from 95% to 100%.
...
<font color =#3fb5bd>Hands on Experience</font>\
...
- Supervision of overall lab operations to optimize turn-around-time, improve operational efficiency, maintain lab accreditation, and environmental legislation compliance. (4 - 10 staff)\
...
- Performed testings including coliform and *E. Coli* water test.
